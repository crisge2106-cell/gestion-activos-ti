#!/usr/bin/env node
/**
 * ACTUALIZACIÓN FINAL CORRECTA
 * 179 equipos con prefijos por tipo
 * LPT- (Laptops), CEL- (Celulares), IMP- (Impresoras), MOU- (Mouses), SCA- (Scanners)
 */
...
console.log('\n🔄 Actualización final con 179 equipos y prefijos...\n');
...
try {
  ...
  console.log(`   ... (${actualizados - 10} equipos más)\n`);
  console.log(`✅ Actualizados: ${actualizados}\n`);

  // Generar nombres para los que falten
  console.log(`🔨 Generando nombres automáticos para equipos sin nombre...`);
  ...
  // Resumen por prefijo
  const prefijos = ['LPT', 'CEL', 'IMP', 'SCA', 'DES'];
